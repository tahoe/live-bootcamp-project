...
impl TwoFACodeStore for RedisTwoFACodeStore {
    #[tracing::instrument(name = "Storing 2FA code in Redis", skip_all)] // New!
    async fn add_code(
        &mut self,
        email: Email,
    ...
    #[tracing::instrument(name = "Removing 2FA code from Redis", skip_all)] // New!
    ...
    #[tracing::instrument(name = "Retrieving 2FA code from Redis", skip_all)] // New!
    async fn get_code(
        &self,
        email: &Email,
