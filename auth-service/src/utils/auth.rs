...
#[tracing::instrument(name = "Generate auth cookie", skip_all)] // New!
...
#[tracing::instrument(name = "Generate auth token", skip_all)] // New!
...
#[tracing::instrument(name = "Validate token", skip_all)] // New!
...
#[tracing::instrument(name = "Create token", skip_all)] // New!
...
mod tests {
    ...
    use crate::{domain::BannedTokenStore, services::data_store::HashsetBannedTokenStore};
